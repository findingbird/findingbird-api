...
export class AuthController {
  ...
  @ApiResponse({
    status: 200,
    description:
      'access token은 response body, refresh token은 refresh-token cookie에 포함되어 있습니다. (https 가 활성화되어야 합니다.)',
  ...
  @ApiOperation({
    ...
    description: '카카오 서버에서 응답을 보내는 엔드포인트 입니다. 클라이언트 단에서 요청하지 않습니다.',
  })
